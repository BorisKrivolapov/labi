...
virtual bool Ecuals(PointOnThePlane &point)   {
return this->x == point.x && this->y == point.y;
}

virtual int CompareToX(PointOnThePlane &point) {
int pointThis = this->x;
int pointOther = point.x;
return forCompare(pointThis, pointOther);
}
virtual int CompareToY(PointOnThePlane &point) {
int pointThis = this->y;
int pointOther = point.y;
return forCompare(pointThis, pointOther);
}
virtual double Distance(PointOnThePlane &point) {
int d = 2;
